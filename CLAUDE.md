# CLAUDE.md — authoring guide for *Calculus, Intuitively*

This is a static, bookdown-style textbook about the ideas of single- and multivariable calculus, built from intuition and pictures, generated
...
- **Audience.** Someone taking Calculus 1–3 who does not think of themselves as a math person. Assume almost nothing: rusty algebra, no comfort with proofs, and a fair amount of math anxiety. Every idea earns a picture and a plain-words intuition before any symbols show up, and no step is treated as too obvious to explain. Teach what the reader needs and no more: where a
...
- **Every chapter should carry its weight in callouts:** at least one Intuition
  box, and Wait, why? boxes for the pointed questions a sharp reader —
...
- **Carry second-question depth.** The concise prose gives the clean *first*
  ...
  Wait, why? boxes and (2) short **second-layer asides** that deepen a
...
- Prose in this book's voice, with at least one Intuition box, the
  Wait, why? boxes a sharp reader would ask, jargon defined on first
...
3. Push the branch to this book's GitHub repo (`zorian15/calculus-intuitively`).
...
(`!!! probe "Wait, why?"`). Keep every other title matching its type.
...
* **The bar:** questions should be *hard* the way a sharp reader's question is
  ...
  confirm. Draw on the same gaps the Wait, why? boxes and asides target,
...
- At least one Intuition box and the Wait, why? questions a sharp reader
  would face you with.
- Carries second-question depth: Wait, why? boxes and short second-layer
