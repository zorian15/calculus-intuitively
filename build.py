"""Static-site generator for *Calculus, Intuitively*.
...
BOOK_TITLE = "Calculus, Intuitively"
BOOK_SUBTITLE = "The ideas behind Calc 1–3, built from pictures and plain words — for anyone who never liked math."
...
# The book's canonical address, e.g. "https://zorian15.github.io/calculus-intuitively".
...
<meta name="apple-mobile-web-app-title" content="Calculus">
<meta name="description" content="A textbook on the ideas of single- and multivariable calculus, built from intuition and pictures.">
"""
...
def quiz_section_html(slug: str) -> str:
    ...
    return (
        ...
        '<p class="quiz-intro">A few questions to check the ideas from this '
...
def sidebar_html(active_slug: str) -> str:
    ...
    parts.append(
        '<a class="book-brand" href="index.html">Calculus,<br>Intuitively'
...
<img class="landing-cover" src="assets/cover.svg" width="640" height="960"
  alt="Cover illustration for Calculus, Intuitively.">
<div>
